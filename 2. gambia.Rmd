...
--This is way too complicated of a model for 1 year of pre-vaccine data
...
mod2.epc.alt <- step_func(ds=ds1, outcome_name='epc', denom='mppop', mod='negbin', other.covars='none')
